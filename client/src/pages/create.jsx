...
export default function CreateAccount() {
  ...
  return (
    ...
    <Grid className="center"  direction="row" container>
      ...
      <h6 style={{color: "white", textAlign: "center"}}>All Fields Required</h6>
        <Grid container spacing={2} direction="row">
          ...
          <Grid className="center" item xs={12}>
            {create.verifyPassword === create.password && create.verifyPassword !== "" ? <button type="submit">Create Account</button> : <></>}
          </Grid>
        </Grid>
      </form>
    </Grid>
